...
Официально данная версия zapret не поддерживает Linux, если вы хотите использовать bat файлы в  Linux, есть программа для использования bat файлов в Linux [тут]
https://gitlab.winehq.org/wine/wine/-/releases/wine-10.0) Проект создан пользователем wine на gitlab
